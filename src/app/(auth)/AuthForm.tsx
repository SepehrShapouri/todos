...
function AuthForm({ formType}: AuthFormTypes) {
  ...
  return (
    <form className="grid gap-4" action={formAction}>
        ...
        <Label  className="text-muted-foreground" htmlFor="email">Email address</Label>
        <Input
          id="email"
          type="email"
          name="email"
      ...
      <ServerSubmitButton title="Sign Up" loadingTitle="redirecting" className="bg-sky-200 hover:bg-sky-400"/>
    </form>
  );
}
